...
/*******************************************************************************
 * Extra 1. 💯 add read only warning + 2. 💯 add a controlled state warning
 ******************************************************************************/
// const callAll =
//   (...fns) =>
//   (...args) =>
...
//   React.useEffect(() => {
//     warning(
//       !(onIsControlled && onChange == null && !readOnly),
...
/*******************************************************************************
 * Extra 3. 💯 extract warnings to a custom hook + 4. 💯 don’t warn in production
 ******************************************************************************/
const callAll =
  (...fns) =>
  (...args) =>
  ...
  if (process.env.NODE_ENV !== 'production') {
    effect = () => {
      warning(
        ...
        `Warning: \`${componentName}\` is changing an uncontrolled input of type undefined to be controlled. Input elements should not switch from uncontrolled to controlled (or vice versa). Decide between using a controlled or uncontrolled input element for the lifetime of the component. Check the \`${controlPropName}\` prop. More info: https://fb.me/react-controlled-components`,
      )
      warning(
        !(!wasControlled && isControlled),
        `Warning: \`${componentName}\` is changing a controlled input of type undefined to be uncontrolled. Input elements should not switch from controlled to uncontrolled (or vice versa). Decide between using a controlled or uncontrolled input element for the lifetime of the component. Check the \`${controlPropName}\` prop. More info: https://fb.me/react-controlled-components`,
      )
    }
  }
